class Prisoners_dilemma:
    ...
    def __init__(self, properties):
        ...
        if self.properties["preferences"] == "ordinal":
            ...
            #self.matrix = [[3,3],[0,5]],[[5,0],[1,1]]   # locks    [pd.canon.1]
            #self.matrix = [[2,2],[-1,3]], [[3,-1],[0,0]]  # does not lock
            #self.matrix = [[30,30],[10,40]], [[40,10],[20,20]] # locks
            self.matrix = [[0.6,0.6],[0,1]], [[1,0],[0.2,0.2]] # locks  pd.scalar.norm [pd.canon.2]
        #self.semantic_view = ('C', 'D')
        #self.mc = [(0,0)]
        print("pd", self.matrix)
