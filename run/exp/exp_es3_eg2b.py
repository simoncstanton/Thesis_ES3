#!/usr/bin/env python3
'''
Experiment Series Three: Experiment Group Two subgroup B
...
import model.world.exp_es3_eg2b as environment
...
def main(argv):
    ...
    env = environment.Exp_es3_eg2b("exp_es3_eg2b", world_config, agents, instance_id, exp_data)
